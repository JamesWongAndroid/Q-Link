...
public class UseGroupRxCardOptionsFragment extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try {
			image_1.setImageBitmap(BitmapFactory.decodeStream(getActivity().getAssets().open("qlink_card_selection_template.png")));
		} catch (Exception e) {
		...
		try {
			image_2.setImageBitmap(BitmapFactory.decodeStream(getActivity().getAssets().open("default_fluffyrxcard_select.png")));
		} catch (Exception e) {
