...
public class FreeGroupRxCardTempletActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		isPet = getIntent().getExtras().getBoolean("isPet");
		try {
		...
		int imageNotFoundID = R.drawable.qlink_cardview_template_two;
		if (isPet) {
			...
			actionbar_info_sold.setVisibility(View.VISIBLE);
			imageNotFoundID = R.drawable.qlink_cardview_template_pet_two;
		}
		try {
